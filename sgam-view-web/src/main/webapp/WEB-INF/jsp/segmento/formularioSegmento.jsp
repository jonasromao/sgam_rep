...
<shiro:hasPermission name="sgam.configuracoes.segmento.incluir:sgam.configuracoes.segmento.editar">
...
<shiro:lacksPermission name="sgam.configuracoes.segmento.incluir:sgam.configuracoes.segmento.editar">
