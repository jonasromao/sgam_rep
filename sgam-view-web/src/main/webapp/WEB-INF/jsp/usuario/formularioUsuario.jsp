...
<shiro:hasPermission name="sgam.configuracoes.usuario.incluir:sgam.configuracoes.usuario.editar">
...
<shiro:lacksPermission name="sgam.configuracoes.usuario.incluir:sgam.configuracoes.usuario.editar">
