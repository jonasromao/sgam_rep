...
<shiro:hasPermission name="sgam.cadastros.comercio.incluir:sgam.cadastros.comercio.editar">
...
<shiro:lacksPermission name="sgam.cadastros.comercio.incluir:sgam.cadastros.comercio.editar">
